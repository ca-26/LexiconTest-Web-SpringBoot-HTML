...
////		basePackages = "com.ca.lextest.db.repository"
////)
...
//	////tell spring to pick up the data source properties that are prefixed with   spring.postgresql.datasource from the application.properties file and build a data source using DataSourceBuilder.
...
////					.packages("com.ca.lextest.db.dao")
