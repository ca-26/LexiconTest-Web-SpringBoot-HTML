...
//)
//public class MySqlConfigOLDWithEntityManagerAccess {
//	    
//	@Autowired
...
//		lef.setPackagesToScan(env.getProperty("spring.mysql.datasource.entities.package"));
//		lef.setJpaVendorAdapter(jpaVendorAdapter);
//		lef.setPersistenceUnitName("mysqlPU");
//		//HibernateJpaVendorAdapter vendorAdapter  = new HibernateJpaVendorAdapter();
//		//em.setJpaVendorAdapter(vendorAdapter);      
//		lef.setJpaPropertyMap(hibernateProperties());
